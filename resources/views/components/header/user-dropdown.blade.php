...
// Fallback foto profil: Menggunakan file avatar jika ada, atau generate gambar inisial nama
...
<div class="relative" x-data="{
    ...
    <button
        ...
        <span class="block mr-1 font-medium text-theme-sm rtl:mr-0 rtl:ml-1">{{ $user->name }}</span>
    ...
    <div
        ...
        <form method="POST" action="{{ route('logout') }}" class="w-full">
            @csrf
            <button type="submit" class="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-500/10">
