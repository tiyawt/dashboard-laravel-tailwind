...
@section('content')
<x-common.page-breadcrumb pageTitle="Barang Keluar" />
    ...
    <div class="mb-4 flex min-w-0 flex-col gap-2 px-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
                Daftar Stock Barang Keluar
            </h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">Kelola data stock barang keluar di sini.</p>
            <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <!-- Form Export Berdasarkan Bulan & Tahun -->
                <form
                    action="{{ route('barang-keluar.export') }}"
                    method="GET"
